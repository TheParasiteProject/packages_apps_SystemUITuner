...
import static com.android.systemui.tuner.R.styleable.lineage_SelfRemovingPreference_minSummaryLines;
import static com.android.systemui.tuner.R.styleable.lineage_SelfRemovingPreference_replacesKey;
    ...
    private boolean checkConstraints() {
        ...
        TypedArray a =
                mContext.getResources()
                        .obtainAttributes(mAttrs, R.styleable.lineage_SelfRemovingPreference);
    ...
    public static boolean resolveIntent(Context context, Intent intent) {
        ...
        List<ResolveInfo> results =
                pm.queryIntentActivitiesAsUser(
                        intent, PackageManager.MATCH_SYSTEM_ONLY, UserHandle.myUserId());
